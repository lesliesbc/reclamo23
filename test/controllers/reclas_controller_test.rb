...
class ReclasControllerTest < ActionController::TestCase
  ...
  test "should create recla" do
    assert_difference('Recla.count') do
      post :create, recla: { cliente_id: @recla.cliente_id, reclamo: @recla.reclamo, tienda: @recla.tienda }
    end
  ...
  test "should update recla" do
    patch :update, id: @recla, recla: { cliente_id: @recla.cliente_id, reclamo: @recla.reclamo, tienda: @recla.tienda }
    assert_redirected_to recla_path(assigns(:recla))
  end
